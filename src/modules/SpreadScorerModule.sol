...
contract SpreadScorerModule is IScorerModule {
     ...
     * @param theNumber The spread value stored as 10x (e.g., -3.5 = -35)
     ...
     * @param _theNumber Point spread value, stored as 10x (e.g., -3.5 = -35).
     *                   Positive means home team is favored, negative means away team is favored.
     *                   Scores are scaled to 10x internally to match theNumber's representation.
     *                   Away side covers when awayScore * 10 + theNumber >= homeScore * 10.
    ...
    function scoreSpread(
        ...
        // add theNumber to away
        int32 adjustedAway = scaledAway + _theNumber;
