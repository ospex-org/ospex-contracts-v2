...
contract ScorerModuleTest is Test {
    ...
    function setUp() public {
        ...
        // Register this test contract as the oracle module so it can call createSpeculation
        bytes32 oracleModuleType = keccak256("ORACLE_MODULE");
        core.registerModule(oracleModuleType, address(this));
    }
    ...
    function testSpread_AwayCovers_NegativeSpread() public {
        // Away favored by 4 (-4), home loses by 3
        uint256 contestId = _storeContest(_contest(16, 12, ContestStatus.Scored));
        int32 spreadNum = -4;
        uint256 speculationId = speculationModule.createSpeculation(
            contestId,
            uint32(block.timestamp + 1),
    ...
    function testSpread_AwayCovers_ExactMargin() public {
        // Home favored by 2, home wins by exactly 2
        uint256 contestId = _storeContest(_contest(10, 12, ContestStatus.Scored));
        int32 spreadNum = 2;
        uint256 speculationId = speculationModule.createSpeculation(
            contestId,
